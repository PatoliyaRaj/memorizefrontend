    ...
    <div className="min-h-screen bg-[#060A09] text-text-primary font-body px-4 py-8 md:py-12 flex flex-col justify-center items-center">
      <div className="w-full max-w-3xl space-y-6">
        ...
        <div className="rounded-3xl border border-border-brand/40 bg-[#0B1210] p-6 md:p-8 shadow-[0_12px_40px_rgba(20,184,166,0.12)] space-y-6 relative overflow-hidden">
            ...
            <div className="space-y-4">
              <label className="block space-y-1.5">
                <span className="text-[10px] font-mono uppercase tracking-widest text-[#9BBFBB] font-bold">
                  Write down details from active recall
                </span>
                <textarea
                  value={answerText}
                  onChange={(e) => setAnswerText(e.target.value)}
                  className="w-full min-h-[160px] rounded-2xl border border-border-default bg-[#060A09] p-4 text-sm md:text-base text-text-primary outline-none transition-all focus:border-primary focus:ring-1 focus:ring-primary placeholder:text-text-tertiary/60 leading-relaxed font-body"
                  placeholder={modeParam === 'exam' ? "Write a short answer quickly! Hints and explanations are locked under exam rules." : "Draft everything you remember about this concept. Writing it down triggers deep synaptic retrieval..."}
                  autoFocus
                />
              </label>
              ...
              <div className="flex justify-end pt-2">
                <Button
                  ...
                  className="bg-[#0D9488] text-white hover:bg-[#14B8A6] px-6 py-2.5 rounded-xl font-bold flex items-center gap-1.5 shadow-[0_4px_12px_rgba(13,148,136,0.2)] text-xs"
                >
                  Reveal & Compare
                </Button>
              </div>
          ...
          {/* Side by Side Reveal Compare & Slider */}
          {showReveal && (
            <div className="space-y-6 animate-fade-in">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="rounded-xl border border-border-default bg-[#060A09] p-4 flex flex-col">
                  ...
                  <div className="text-sm text-text-secondary leading-relaxed flex-1 whitespace-pre-wrap font-body">
                ...
                {modeParam === 'exam' ? (
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-3">
                      <Button
                        onClick={() => submitAnswer(true, 4)} // Good FSRS rating
                        disabled={submitting}
                        className="flex-1 bg-emerald-600 hover:bg-emerald-500 text-white font-bold h-11 text-sm rounded-xl flex items-center justify-center gap-1.5"
                      >
                        <span className="material-symbols-outlined text-sm">check_circle</span>
                        Correct
                      </Button>
                      <Button
                        onClick={() => submitAnswer(false)} // Fail FSRS rating
                        disabled={submitting}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                      <div className="flex-1 grid grid-cols-5 gap-2">
                        {[1, 2, 3, 4, 5].map((grade) => (
                          <button
                            ...
                            disabled={submitting}
                            className={cn(
                              "py-2.5 px-3 border text-xs font-bold rounded-lg font-mono transition-all duration-200",
                      ...
                      <Button
                        ...
                        disabled={submitting}
                        className="bg-[#4A1A1A] border border-red-500/20 hover:bg-[#591C02] text-[#F87171] rounded-lg text-xs font-bold px-4 h-10 whitespace-nowrap"
                      >
                        I was incorrect
                      </Button>
                    </div>
